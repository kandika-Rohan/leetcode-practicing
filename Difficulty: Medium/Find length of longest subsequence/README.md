<h2><a href="https://www.geeksforgeeks.org/problems/find-length-of-longest-subsequence4905/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Find length of longest subsequence</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two string&nbsp;<strong>X</strong>&nbsp;and&nbsp;<strong>Y </strong>of length <strong>N </strong>and<strong> M </strong>respectively. The task is to find the length of the longest subsequence of string X which is a substring in sequence Y.</span></p>
