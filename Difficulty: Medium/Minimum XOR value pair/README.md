<h2><a href="https://www.geeksforgeeks.org/problems/minimum-xor-value-pair/1?page=1&category=Trie&status=unsolved&sortBy=submissions">Minimum XOR value pair</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of&nbsp;integers of size N find minimum xor of any 2 elements.</span></p>
