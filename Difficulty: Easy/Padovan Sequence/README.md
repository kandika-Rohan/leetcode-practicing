<h2><a href="https://www.geeksforgeeks.org/problems/padovan-sequence2855/1?page=4&category=Dynamic%20Programming&sortBy=submissions">Padovan Sequence</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a number <strong>n</strong>, find the <strong>n<sup>th</sup></strong>&nbsp;number in the <em>Padovan Sequence</em>.</span></p>
<blockquote>
