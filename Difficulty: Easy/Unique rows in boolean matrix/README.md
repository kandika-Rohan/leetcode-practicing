<h2><a href="https://www.geeksforgeeks.org/problems/unique-rows-in-boolean-matrix/1?page=3&company=Zoho&sortBy=submissions">Unique rows in boolean matrix</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a binary matrix your task is to find all unique rows of the given matrix in the order of their appearance in the matrix. </span></p>
