<h2><a href="https://www.geeksforgeeks.org/problems/count-the-characters1821/1?page=4&company=Zoho&sortBy=submissions">Count the characters</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S. Count the characters that have ‘N’ number of occurrences. If a character appears consecutively it is counted as 1 occurrence.</span></p>
